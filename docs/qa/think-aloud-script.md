...
5. **Continue with one hand.** “Get to the live screen.” Results → Guide me there should take one action tap. Count scrolling and backtracking separately. Note grip changes, missed targets, and whether the user confuses opening Live with actually starting the sprint.
